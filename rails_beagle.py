...
class RailsBeagleCommand(sublime_plugin.WindowCommand):
    def run(self, index=None):
        ...
        if active_file_path:
            if self.__patterns():
                self.__beagle = Beagle(active_file_path, self.__patterns(), active_folders)
    ...
    def __patterns(self):
        return sublime.load_settings("RailsBeagle.sublime-settings").get('patterns')
